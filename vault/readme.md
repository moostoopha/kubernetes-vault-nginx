...
install kind VIA brew you can skip the step if you already have installed
...
```
cd kubernetes-vault-nginx/vault
...
We can use chart `1.0.1` which is the latest at the time of this demo
...
sudo -E kubectl -n vault port-forward svc/vault-ui 443:8200
```
